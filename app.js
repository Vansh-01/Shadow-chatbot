...
function takeCommand(message) {
    if (message.includes('hey') || message.includes('hello') || message.includes('Hi')|| message.includes('hi')) {
        speak("Hello Boss, How May I Help You?");
    } 
    else if(message.includes('how are you')){
        speak("I am fine thanks for asking , how may i help u")
    }
    ...
    else if (message.includes("open give horoscope")) {
            window.open("https://www.hindustantimes.com/astrology/horoscope", "_blank");
            speak("Opening daily horoscope...");}    

    else if (message.includes("open google")) {
        window.open("https://google.com", "_blank");
        speak("Roger that Opening Google...");
